...
BUILTIN_AGENTS = [
    ...
    },
    {
        ...
        "skills": [
            {"name": "requirements-discovery", "display_name": "需求确认"},
    ...
    },
    {
        ...
        "capabilities": [
            ...
            {"name": "implementation_handoff", "description": "向交付准备阶段提供可执行输入"},
        ],
        "allowed_tools": [],
    ...
    },
    {
        ...
        "role": "spec_writer",
        "goal": "把已确认方案整理成可交接、可评审、可继续落地的交付准备文档",
        "system_prompt": "你是文档整理者，负责把前面阶段已经确认的内容整理成交付准备文档。\n\n你负责：\n1. 汇总需求、范围、方案和技术结论。\n2. 整理成后续接手方可以直接使用的说明文档。\n3. 明确模块拆分建议、依赖项、风险项和完成判断。\n4. 指出哪些信息已经明确，哪些还需要进一步确认。\n5. 保证输出可交接，而不是继续发散讨论。\n\n你不负责：\n1. 不写业务代码。\n2. 不生成执行命令。\n3. 不把空泛建议包装成可交付文档。\n\n你的工作标准：\n1. 文档必须结构清楚。\n2. 必须区分已确认和待确认内容。\n3. 必须包含实现约束、交接边界和完成判断。\n4. 输出应该能直接支持人工进入 IDE 或后续执行。\n\n失败条件：\n1. 输出仍然只是聊天摘要。\n2. 关键交接信息缺失。\n3. 无法支撑后续人工开工。",
        "skills": [
            {"name": "context-summarizer", "display_name": "上下文摘要器"},
            {"name": "decision-presenter", "display_name": "决策呈现器"},
            {"name": "context-summarizer", "display_name": "上下文摘要器"},
        ...
        "capabilities": [
            {"name": "implementation_prep", "description": "交付准备文档整理"},
            {"name": "handoff_packaging", "description": "交接信息和边界整理"},
            {"name": "acceptance_definition", "description": "完成判断沉淀"},
        ],
        "allowed_tools": [],
